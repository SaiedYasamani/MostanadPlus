package net.jhoobin.bouncycastle.crypto.encodings;

import net.jhoobin.bouncycastle.crypto.AsymmetricBlockCipher;
import net.jhoobin.bouncycastle.crypto.CipherParameters;
import net.jhoobin.bouncycastle.crypto.InvalidCipherTextException;
import net.jhoobin.bouncycastle.crypto.params.AsymmetricKeyParameter;
import net.jhoobin.bouncycastle.crypto.params.ParametersWithRandom;
...
public class PKCS1Encoding
     ...
     */
    public static final String STRICT_LENGTH_ENABLED_PROPERTY = "net.jhoobin.bouncycastle.pkcs1.strict";

    /**
     * some providers fail to include the leading zero in PKCS1 encoded blocks. If you need to
     * work with one of these set the system property net.jhoobin.bouncycastle.pkcs1.not_strict to true.
     * <p>
     * The system property is checked during construction of the encoding object, it is set to
     * false by default.
     * </p>
     */
    public static final String NOT_STRICT_LENGTH_ENABLED_PROPERTY = "net.jhoobin.bouncycastle.pkcs1.not_strict";
